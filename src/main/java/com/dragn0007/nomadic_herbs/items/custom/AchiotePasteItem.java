...
public class AchiotePasteItem extends HerbalItem {

    public AchiotePasteItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.achiote_paste.tooltip").withStyle(ChatFormatting.GRAY));
