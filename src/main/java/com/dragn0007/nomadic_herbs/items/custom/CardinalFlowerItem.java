...
public class CardinalFlowerItem extends HerbalNameBlockItem {

    public CardinalFlowerItem(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.cardinal_flower_plants.tooltip").withStyle(ChatFormatting.GRAY));
