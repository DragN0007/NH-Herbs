...
public class EpherdraItem extends HerbalNameBlockItem {

    public EpherdraItem(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.epherdra.tooltip").withStyle(ChatFormatting.GRAY));
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.epherdra_plants.tooltip").withStyle(ChatFormatting.GRAY));
