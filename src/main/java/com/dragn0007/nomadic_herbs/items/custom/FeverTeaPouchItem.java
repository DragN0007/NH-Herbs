...
public class FeverTeaPouchItem extends DrinkItem {
    private final Fluid content = Fluids.WATER;

    public FeverTeaPouchItem() {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.fever_tea_pouch.tooltip").withStyle(ChatFormatting.GRAY));
    }
}