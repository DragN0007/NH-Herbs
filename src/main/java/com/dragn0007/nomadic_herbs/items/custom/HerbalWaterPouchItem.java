...
public class HerbalWaterPouchItem extends DrinkItem {
    private final Fluid content = Fluids.WATER;

    public HerbalWaterPouchItem() {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.herbal_water_pouch.tooltip").withStyle(ChatFormatting.GRAY));
    }
}