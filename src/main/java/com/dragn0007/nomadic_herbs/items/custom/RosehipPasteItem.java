...
public class RosehipPasteItem extends HerbalItem {

    public RosehipPasteItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.rosehip_paste.tooltip").withStyle(ChatFormatting.GRAY));
