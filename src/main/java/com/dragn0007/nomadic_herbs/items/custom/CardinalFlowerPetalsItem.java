...
public class CardinalFlowerPetalsItem extends HerbalItem {

    public CardinalFlowerPetalsItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.cardinal_flower_petals.tooltip").withStyle(ChatFormatting.GRAY));
