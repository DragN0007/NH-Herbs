...
public class HawthornWaterPouchItem extends DrinkItem {
    private final Fluid content = Fluids.WATER;

    public HawthornWaterPouchItem() {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.hawthorn_water_pouch.tooltip").withStyle(ChatFormatting.GRAY));
    }
}