...
public class JewelweedStemsItem extends HerbalItem {

    public JewelweedStemsItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.jewelweed_stems.tooltip").withStyle(ChatFormatting.GRAY));
