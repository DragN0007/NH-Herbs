...
public class CreosoteClusterItem extends HerbalNameBlockItem {

    public CreosoteClusterItem(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.creosote_cluster.tooltip").withStyle(ChatFormatting.GRAY));
