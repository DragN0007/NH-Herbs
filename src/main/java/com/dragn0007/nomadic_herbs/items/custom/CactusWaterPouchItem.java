...
public class CactusWaterPouchItem extends DrinkItem {
    private final Fluid content = Fluids.WATER;

    public CactusWaterPouchItem() {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.cactus_water_pouch.tooltip").withStyle(ChatFormatting.GRAY));
    }
}