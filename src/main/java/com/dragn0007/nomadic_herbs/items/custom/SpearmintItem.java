...
public class SpearmintItem extends HerbalNameBlockItem {

    public SpearmintItem(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.spearmint.tooltip").withStyle(ChatFormatting.GRAY));
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.spearmint_plants.tooltip").withStyle(ChatFormatting.GRAY));
