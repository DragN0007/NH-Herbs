...
public class BrittlebushClusterItem extends HerbalNameBlockItem {

    public BrittlebushClusterItem(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.brittlebush_cluster.tooltip").withStyle(ChatFormatting.GRAY));
