...
public class ShreddedCurareItem extends HerbalItem {

    public ShreddedCurareItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.shredded_curare.tooltip").withStyle(ChatFormatting.GRAY));
