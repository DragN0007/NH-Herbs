...
public class SnakesBloodItem extends HerbalItem {

    public SnakesBloodItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.nomadic_herbs.clay_paste.tooltip").withStyle(ChatFormatting.GRAY));
