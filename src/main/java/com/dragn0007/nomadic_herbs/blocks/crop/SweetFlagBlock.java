...
public class SweetFlagBlock extends HerbCropBlock {
   ...
   public SweetFlagBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.SWEET_FLAG.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.SWEET_FLAG_CLUSTER.get();
   }
