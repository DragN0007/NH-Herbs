...
public class CatsClawBlock extends HerbCropBlock {
   ...
   public CatsClawBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.CATS_CLAW.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.CATS_CLAW.get();
   }
