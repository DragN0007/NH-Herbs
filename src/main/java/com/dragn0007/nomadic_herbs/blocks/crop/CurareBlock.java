...
public class CurareBlock extends HerbCropBlock {
   ...
   public CurareBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.CURARE.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.CURARE.get();
   }
