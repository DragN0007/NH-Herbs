...
public class SpearmintBlock extends HerbCropBlock {
   ...
   public SpearmintBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.SPEARMINT.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.SPEARMINT.get();
   }
