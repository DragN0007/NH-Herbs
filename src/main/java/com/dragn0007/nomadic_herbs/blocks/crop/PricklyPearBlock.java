...
public class PricklyPearBlock extends HerbCropBlock {
   ...
   public PricklyPearBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.PRICKLY_PEAR.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.PRICKLY_PEAR.get();
   }
