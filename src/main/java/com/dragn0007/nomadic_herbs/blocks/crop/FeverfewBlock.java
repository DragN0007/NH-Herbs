...
public class FeverfewBlock extends HerbCropBlock {
   ...
   public FeverfewBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.FEVERFEW.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.FEVERFEW_CLUSTER.get();
   }
