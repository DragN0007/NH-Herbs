...
public class PeyoteBlock extends HerbCropBlock {
   ...
   public PeyoteBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.PEYOTE.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.PEYOTE.get();
   }
