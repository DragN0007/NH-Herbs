...
public class LavenderBlock extends HerbCropBlock {
   ...
   public LavenderBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.LAVENDER.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.LAVENDER.get();
   }
