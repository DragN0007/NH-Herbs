...
public class MilkweedBlock extends HerbCropBlock {
   ...
   public MilkweedBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.MILKWEED.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.MILKWEED_CLUSTER.get();
   }
