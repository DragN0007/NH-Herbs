...
public class GingerBlock extends HerbCropBlock {
   ...
   public GingerBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.GINGER.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.GINGER.get();
   }
