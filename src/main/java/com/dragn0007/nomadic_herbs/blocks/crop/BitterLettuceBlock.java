...
public class BitterLettuceBlock extends HerbCropBlock {
   ...
   public BitterLettuceBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.BITTER_LETTUCE.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.BITTER_LETTUCE.get();
   }
