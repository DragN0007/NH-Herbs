...
public class AchioteBlock extends HerbCropBlock {
   ...
   public AchioteBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.ACHIOTE.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.ACHIOTE.get();
   }
