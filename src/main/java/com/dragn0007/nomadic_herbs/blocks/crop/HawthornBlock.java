...
public class HawthornBlock extends HerbCropBlock {
   ...
   public HawthornBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.HAWTHORN.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.HAWTHORN_BERRY.get();
   }
