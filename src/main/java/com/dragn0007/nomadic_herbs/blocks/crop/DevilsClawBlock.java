...
public class DevilsClawBlock extends HerbCropBlock {
   ...
   public DevilsClawBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.DEVILS_CLAW.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.DEVILS_CLAW_SEEDS.get();
   }
