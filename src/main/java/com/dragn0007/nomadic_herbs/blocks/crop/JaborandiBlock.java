...
public class JaborandiBlock extends HerbCropBlock {
   ...
   public JaborandiBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.JABORANDI.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.JABORANDI.get();
   }
