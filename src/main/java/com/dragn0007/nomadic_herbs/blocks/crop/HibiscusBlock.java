...
public class HibiscusBlock extends HerbCropBlock {
   ...
   public HibiscusBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.HIBISCUS.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.HIBISCUS_CLUSTER.get();
   }
