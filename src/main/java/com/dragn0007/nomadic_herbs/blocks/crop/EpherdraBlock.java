...
public class EpherdraBlock extends HerbCropBlock {
   ...
   public EpherdraBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.EPHERDRA.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.EPHERDRA_CLUSTER.get();
   }
