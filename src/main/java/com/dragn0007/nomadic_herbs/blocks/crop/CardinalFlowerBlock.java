package com.dragn0007.nomadic_herbs.blocks.crop;
...
public class CardinalFlowerBlock extends HerbCropBlock {
   ...
   public CardinalFlowerBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.CARDINAL_FLOWER.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.CARDINAL_FLOWER.get();
   }
