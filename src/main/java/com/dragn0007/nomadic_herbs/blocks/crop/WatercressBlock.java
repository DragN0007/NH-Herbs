...
public class WatercressBlock extends HerbCropBlock {
   ...
   public WatercressBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.WATERCRESS.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.WATERCRESS_CLUSTER.get();
   }
