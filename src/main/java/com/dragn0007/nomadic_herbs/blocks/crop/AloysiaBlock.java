...
public class AloysiaBlock extends HerbCropBlock {
   ...
   public AloysiaBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.ALOYSIA.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.ALOYSIA.get();
   }
