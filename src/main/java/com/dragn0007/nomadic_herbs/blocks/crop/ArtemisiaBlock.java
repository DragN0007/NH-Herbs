...
public class ArtemisiaBlock extends HerbCropBlock {
   ...
   public ArtemisiaBlock(Properties p_51328_) {
      super(p_51328_);
   }

   @Override
   public BlockState getPlant(BlockGetter level, BlockPos pos) {
      return NHBlocks.ARTEMISIA.get().defaultBlockState();
   }

   public ItemLike getBaseSeedId() {
      return NHItems.ARTEMISIA.get();
   }
